...
const MENU_ITEM_COLUMNS_DEFINITION = [
    ...
    {
        type: 'text',
        fieldName: 'menuItemType',
        label: 'Type',
        initialWidth: 100
    },
    {
        type: 'text',
        fieldName: 'menuItemStyle',
        label: 'Style',
        initialWidth: 100
    }
];

const cleanMenuItemFields = ['position','openInNewWindow','level','language','label','_children','isPublic','iconPosition','icon','href','menuItemType','menuItemStyle'];
